function Cart(localStorageKey) {
    ...
    const cart = {
        ...
        loadFromStorage() {
            this.cartItems = JSON.parse(localStorage.getItem(localStorageKey)); // Retreaving the cart values as stored in the local storage
            ...
            saveToStorage() {
                localStorage.setItem(localStorageKey, JSON.stringify(this.cartItems)); // function to save the cart into local storage
            },
